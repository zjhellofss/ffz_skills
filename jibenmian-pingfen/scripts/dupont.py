...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--facts", type=Path, required=True, help="caiwu-fenxi facts.csv")
    parser.add_argument("--source-root", type=Path, help="事实来源根目录")
